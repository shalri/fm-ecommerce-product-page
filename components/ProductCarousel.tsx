    ...
    <div className="z-10">
      ...
      <div className="relative sm:hover:cursor-zoom-in">
        ...
        <div className="absolute top-[130px] flex w-full justify-between px-4 sm:hidden">
          <button
            className="h-[40px] w-[40px] rounded-full bg-ep-white bg-[url(/fm-ecommerce-product-page/images/icon-previous.svg)] bg-[length:9px_auto] bg-center bg-no-repeat"
            onClick={prevImage}
          ></button>
          <button
            className="h-[40px] w-[40px] rounded-full bg-ep-white bg-[url(/fm-ecommerce-product-page/images/icon-next.svg)] bg-[length:9px_auto] bg-center bg-no-repeat"
            onClick={nextImage}
          ></button>
        </div>
      </div>
